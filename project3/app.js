...
let allSelects = document.querySelectorAll("select"); // 靜態 NodeList
...
function handleSorting(direction) {
  ...
  objectArray.sort((a, b) => {
    return a.class_grade_number - b.class_grade_number;
  });
  if (direction == "descending") {
    objectArray = objectArray.reverse();
  }
  // 根據 object array 的內容，來更新網頁
